        ...
        <div class="row">
          <div class="full">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              ...
              <div class="col-lg-6 col-md-4 col-sm-4 col-xs-12 adress_cont">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 contant_form">
              <h2 class="text_align_center">For any query</h2>
              <div class="form_section">
                <form method="post" action="index.html">
                  <fieldset>
                  <div class="row">
                    <div class="field col-lg-6 col-md-6 col-sm-12 col-xs-12">
                      <input class="field_custom" placeholder="Your phone no" type="text" name="phoneno">
                    </div>
                    <div class="field col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    ...
                    <div class="field col-lg-6 col-md-6 col-sm-12 col-xs-12">
                      <input class="field_custom" placeholder="Address" type="text" name="address">
                    </div>
